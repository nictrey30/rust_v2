...
fn main() {
    ...
    // the dbg! macro takes ownership of an expression(as opposed to println!, which takes a reference), prints to error console stream, then returns ownership of the value
    let scale = 2;
    let rect2 = Rectangle {
