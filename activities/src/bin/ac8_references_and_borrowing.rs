...
fn main() {
    ...
    // the &s1 syntaxlet us create a reference that refers to the value of s1 but does not own it.
...
fn calculate_length(s: &String) -> usize {
    s.len()
} // here s goes out of scope. But because it does not have ownershipof what it refers to, the String is not dropped.
